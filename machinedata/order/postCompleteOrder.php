...
$insertSql = "INSERT INTO machinedata (timestamp, userid, value, orderIdentifier, shift_idShift) 
              VALUES ('$timestamp', '$userid', 'completed', '$orderIdentifikation', '$shift_id')";

if ($machineconn->query($insertSql) === TRUE) {
    http_response_code(200);
    echo json_encode(["message" => "Auftrag erfolgreich beendet.", "orderId" => $orderIdentifikation], JSON_PRETTY_PRINT);
} else {
    http_response_code(400);
