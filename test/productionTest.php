...
$output1 = [];
exec("start /B C:\\xampp\\php\\php.exe start_machine.php 1 dj198ma 189023710 $apiKey " . rand(5, 10) . " 4 4 3 3533 2>&1", $output1);
...
$output4 = [];
exec("start /B C:\\xampp\\php\\php.exe start_machine.php 2 mn123op 237861471 $apiKey " . rand(5, 10) . " 4 2 1 3533 2>&1", $output4);
echo "Output für Maschine 2:\n" . implode("\n", $output4) . "\n";
